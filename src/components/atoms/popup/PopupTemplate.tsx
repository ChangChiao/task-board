    ...
    >
      ...
      >
        <div className="flex items-center justify-center h-12 bg-cyan-900">
          ...
          <button
            type="button"
            className="absolute top-1 right-2.5 text-white bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
